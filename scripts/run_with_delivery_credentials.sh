...
setenv_args=()
for env_name in RESEND_FROM RESEND_TO NODE_ENV INSTAPAPER_ACTION_BASE_URL INSTAPAPER_ACTION_SECRET INSTAPAPER_ACTION_TOKEN_TTL_DAYS INSTAPAPER_DELIVERY_NAME INSTAPAPER_DELIVERY_FOLDER_ID INSTAPAPER_DELIVERY_FOLDER_NAME INSTAPAPER_DELIVERY_SUMMARY_LABEL INSTAPAPER_DELIVERY_CARD_LABEL INSTAPAPER_DELIVERY_FORMAT; do
  if [[ -n "${!env_name:-}" ]]; then
